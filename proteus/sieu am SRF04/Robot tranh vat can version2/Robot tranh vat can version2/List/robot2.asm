...
_0x67:
	.DB  0x0,0x0
_0x0:
	.DB  0x20,0x6C,0x75,0x69,0x20,0x74,0x72,0x61
	.DB  0x69,0x0,0x20,0x6C,0x75,0x69,0x20,0x70
	.DB  0x68,0x61,0x69,0x0,0x20,0x52,0x65,0x20
	.DB  0x74,0x72,0x61,0x69,0x0,0x20,0x52,0x65
	.DB  0x20,0x70,0x68,0x61,0x69,0x0,0x20,0x74
	.DB  0x69,0x65,0x6E,0x0,0x44,0x61,0x6E,0x67
	.DB  0x20,0x51,0x75,0x6F,0x63,0x20,0x56,0x69
	.DB  0x65,0x74,0x0,0x25,0x32,0x64,0x20,0x63
	.DB  0x6D,0x0
_0x2020003:
	.DB  0x80,0xC0
...
_ext_int0_isr:
	CALL SUBOPT_0x0
; 0000 0030 //lcd_puts("asas");
; 0000 0031 count1 = TCNT1;
	__INWR 8,9,44
; 0000 0032 count1 = count1/58;
	MOVW R26,R8
	LDI  R30,LOW(58)
	LDI  R31,HIGH(58)
	CALL __DIVW21U
	MOVW R8,R30
; 0000 0033 count1 = count1 - 7;
	MOVW R30,R8
	SBIW R30,7
	MOVW R8,R30
; 0000 0034 }
...
_ext_int1_isr:
	CALL SUBOPT_0x0
; 0000 0039 count2 = TCNT1 - temp;
	IN   R30,0x2C
	IN   R31,0x2C+1
	SUB  R30,R4
	SBC  R31,R5
	MOVW R10,R30
; 0000 003A count2 = count2/58;
	MOVW R26,R10
	LDI  R30,LOW(58)
	LDI  R31,HIGH(58)
	CALL __DIVW21U
...
; 0000 0044 trigger = 0;
	CBI  0x18,0
; 0000 0045 trigger1 = 0;
	CBI  0x18,1
; 0000 0046 delay_us(1);
	__DELAY_USB 3
; 0000 0047 trigger = 1;
	SBI  0x18,0
; 0000 0048 delay_us(50);
	__DELAY_USB 133
; 0000 0049 trigger1 = 1;
	SBI  0x18,1
; 0000 004A delay_ms(12);
	LDI  R30,LOW(12)
	LDI  R31,HIGH(12)
	CALL SUBOPT_0x1
; 0000 004B trigger = 0;
	CBI  0x18,0
; 0000 004C delay_us(50);
	__DELAY_USB 133
; 0000 004D trigger1 = 0;
	CBI  0x18,1
; 0000 004E 
; 0000 004F 
; 0000 0050 
...
; 0000 00AA // Func7=In Func6=In Func5=In Func4=In Func3=In Func2=In Func1=Out Func0=Out
; 0000 00AB // State7=T State6=T State5=T State4=T State3=T State2=T State1=0 State0=0
...
; 0000 00BA // Clock value: 1000,000 kHz
...
; 0000 00DA // INT0: On
; 0000 00DB // INT0 Mode: Falling Edge
; 0000 00DC // INT1: On
...
; 0000 00E9 UCSRB=0x00;
	OUT  0xA,R30
; 0000 00EA 
; 0000 00EB // Analog Comparator initialization
; 0000 00EC // Analog Comparator: Off
; 0000 00ED // Analog Comparator Input Capture by Timer/Counter 1: Off
; 0000 00EE ACSR=0x80;
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 00EF SFIOR=0x00;
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 00F0 
; 0000 00F1 // ADC initialization
; 0000 00F2 // ADC disabled
; 0000 00F3 ADCSRA=0x00;
	OUT  0x6,R30
; 0000 00F4 
...
; 0000 00FA // TWI disabled
; 0000 00FB TWCR=0x00;
	OUT  0x36,R30
; 0000 00FC 
; 0000 00FD // Alphanumeric LCD initialization
; 0000 00FE // Connections specified in the
; 0000 00FF // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:
; 0000 0100 // RS - PORTC Bit 0
; 0000 0101 // RD - PORTC Bit 1
; 0000 0102 // EN - PORTC Bit 2
; 0000 0103 // D4 - PORTC Bit 4
; 0000 0104 // D5 - PORTC Bit 5
; 0000 0105 // D6 - PORTC Bit 6
; 0000 0106 // D7 - PORTC Bit 7
; 0000 0107 // Characters/line: 8
; 0000 0108 lcd_init(16);
	LDI  R30,LOW(16)
	ST   -Y,R30
	CALL _lcd_init
; 0000 0109 lcd_puts("Dang Quoc Viet");
	__POINTW1MN _0x44,0
	CALL SUBOPT_0x4
; 0000 010A delay_ms(2000);
	LDI  R30,LOW(2000)
	LDI  R31,HIGH(2000)
	CALL SUBOPT_0x1
; 0000 010B lcd_clear();
...
; 0000 0113 TCNT1 = 0;
	...
	OUT  0x2C+1,R31
	OUT  0x2C,R30
; 0000 0114 while(echo == 0){};
_0x48:
	SBIS 0x10,2
	RJMP _0x48
; 0000 0115 TCCR1B = 0x02;
	LDI  R30,LOW(2)
	OUT  0x2E,R30
; 0000 0116 while (echo1 == 0) {};
_0x4B:
	SBIS 0x10,3
	RJMP _0x4B
; 0000 0117 temp = TCNT1;
	__INWR 4,5,44
; 0000 0118 timeout = 0;
	CLR  R7
; 0000 0119 while((echo == 1)&&(timeout < 10))
_0x4E:
	SBIS 0x10,2
	RJMP _0x51
	LDI  R30,LOW(10)
...
; 0000 0120 if(count1 < 45)
	...
	BRSH _0x53
; 0000 0121 {
; 0000 0122 turn_right();
	RCALL _turn_right
; 0000 0123 
; 0000 0124     if((count1 < 30)&&(count2 < 30))
	LDI  R30,LOW(30)
	LDI  R31,HIGH(30)
	CP   R8,R30
	CPC  R9,R31
...
; 0000 0128         if(count1 < count2)
	__CPWRR 8,9,10,11
	BRSH _0x57
; 0000 0129             {
; 0000 012A              lui_trai();
	RCALL _lui_trai
; 0000 012B              delay_ms(150);
	RJMP _0x64
; 0000 012C             }
; 0000 012D         else if (count1 >=count2)
_0x57:
	__CPWRR 8,9,10,11
	BRLO _0x59
; 0000 012E             {
...
; 0000 0137     turn_left();
	RCALL _turn_left
; 0000 0138     if((count1 < 30)&&(count2 < 30))
	LDI  R30,LOW(30)
	LDI  R31,HIGH(30)
	CP   R8,R30
	CPC  R9,R31
...
; 0000 013C         if(count1 < count2)
	__CPWRR 8,9,10,11
	BRSH _0x5F
; 0000 013D             {
; 0000 013E              lui_trai();
	RCALL _lui_trai
; 0000 013F              delay_ms(150);
	RJMP _0x65
; 0000 0140             }
; 0000 0141         else if (count1 >=count2)
_0x5F:
	__CPWRR 8,9,10,11
	BRLO _0x61
; 0000 0142             {
...
; 0000 014D lcd_gotoxy(0,0);
	LDI  R30,LOW(0)
	CALL SUBOPT_0x6
; 0000 014E sprintf (dis,"%2d cm", count1);
	MOVW R30,R8
	CALL SUBOPT_0x7
; 0000 014F lcd_puts(dis);
; 0000 0150 lcd_gotoxy(10,0);
	LDI  R30,LOW(10)
	CALL SUBOPT_0x6
; 0000 0151 sprintf (dis,"%2d cm",count2);
	MOVW R30,R10
	CALL SUBOPT_0x7
; 0000 0152 lcd_puts(dis);
; 0000 0153 //delay_ms(40);
; 0000 0154     }
	RJMP _0x45
; 0000 0155 }
_0x63:
